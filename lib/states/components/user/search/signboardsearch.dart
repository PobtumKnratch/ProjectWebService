...
class SignboardSearch extends StatefulWidget {
  const SignboardSearch({Key? key}) : super(key: key);

  @override
  _SignboardState createState() => _SignboardState();
}

class _SignboardState extends State<SignboardSearch> {
  List<String> upload3 = [];
  ...
  Future<List<Upload3>> getupload3() async {
    ...
    if (response.statusCode == 200) {
      return upload3FromJson(response.body);
    } else {
