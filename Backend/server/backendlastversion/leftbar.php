            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        ...
                        <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="./evalution_pic/evalution_food.php">ภาพถ่ายรีวิวอาหารพื้นเมือง</a>
                                <a class="nav-link" href="./evalution_pic/evalution_travel.php">ถาพถ่ายวัฒนธรรมและชุมช</a>
                                <a class="nav-link" href="./evalution_pic/evalution_signboard.php">ภาพถ่ายตามป้าย</a>
                                <a class="nav-link" href="./evalution_pic/evalution_scenario.php">ภาพถ่ายตามโจทย์</a>
                            </nav>
                        </div>
                    </nav>
                </div>
