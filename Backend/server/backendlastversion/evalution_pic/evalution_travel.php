...
$data_lawyer = "SELECT * FROM fileupload2 WHERE id ";
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="../pictur_data/fileupload2/<?php echo $post_picture ?>" class="align-self-center mr-3" width="90" height="90" alt="image_food"> </td>
                                    <td>
                                        <a href="evalution_data_travel.php?edit=<?php echo $post_id; ?>" class="btn btn-success"> Checking </a>
