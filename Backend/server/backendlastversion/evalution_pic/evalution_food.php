...
$data_lawyer = "SELECT * FROM fileupload WHERE id ";
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="../pictur_data/fileupload/<?php echo $post_picture ?>" class="align-self-center mr-3" width="90" height="90" alt="image_food">
                                    </td>
                                    <td>
                                        <a href="evalution_data_food.php?edit=<?php echo $post_id; ?>" class="btn btn-success"> Checking </a>
