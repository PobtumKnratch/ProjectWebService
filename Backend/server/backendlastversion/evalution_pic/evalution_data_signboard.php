...
if (isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $sql = "SELECT * FROM fileupload3 WHERE id = $edit_id";
...
<body class="sb-nav-fixed" style="font-family: 'Mali', cursive;">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="evalution_success.php?edit_form=<?php echo $post_id ?>" method="post" enctype="multipart/form-data" name="update" id="update_profile">
                        ...
                        <img id="canvasimg" src="../pictur_data/fileupload3/<?php echo $post_picture ?>" style="display: flex; width: 300px;height: 300px;" />
                        <div class="mt-3">
            ...
            <form action="evalution_signboard.php">
                <div>
