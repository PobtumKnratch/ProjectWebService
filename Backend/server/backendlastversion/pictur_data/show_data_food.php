...
if (isset($_REQUEST['update_id'])) {
    try {
        ...
        $select_stmt = $cont->prepare('SELECT *  FROM fileupload WHERE id=:id ');
...
if (isset($_REQUEST['btn_update'])) {
    try {
            ...
            if ($type == "image/jpg" || $type == 'image/jpeg' || $type == "image/png" || $type == "image/gif") {
                if (!file_exists($path)) {
                    if ($size < 5000000) {
                        ...
                        move_uploaded_file($temp, "fileupload/" . $img_file);
                    } else {
        ...
        if (!isset($errorMsg)) {
            $update_stmt = $cont->prepare("UPDATE fileupload SET name=:name_up,image=:file_up ,tag=:tag Where id=:id ");
                        ...
                        <div class="card" style="font-family: 'Mali', cursive;">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-rabel" style="font-family: 'Mali', cursive;"><?php echo $getname; ?></label>
                                    <div class="col-sm-11">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-rabel" style="font-family: 'Mali', cursive;"><?php echo $row['image']; ?></label>
                                    <!-- <div class="col-sm-11">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-rabel" style="font-family: 'Mali', cursive;"><?php echo $gettag ?></label>
                                    <!-- <div class="col-sm-11">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        &nbsp;
                                        <a href="food.php" class="btn btn-danger" style="font-family: 'Mali', cursive;">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
