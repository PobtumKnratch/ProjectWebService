...
if (isset($_REQUEST['update_id'])) {
    try {
        ...
        $select_stmt = $cont->prepare('SELECT *  FROM fileupload2 WHERE id=:id ');
...
if (isset($_REQUEST['btn_update'])) {
    try {
        ...
        $path = "fileupload2/" . $img_file;
        $directory = "fileupload2/";
            ...
            if ($type == "image/jpg" || $type == 'image/jpeg' || $type == "image/png" || $type == "image/gif") {
                if (!file_exists($path)) {
                    if ($size < 5000000) {
                        ...
                        move_uploaded_file($temp, "fileupload2/" . $img_file);
                    } else {
        ...
        if (!isset($errorMsg)) {
            $update_stmt = $cont->prepare("UPDATE fileupload2 SET name=:name_up,image=:file_up ,tag=:tag Where id=:id ");
                            ...
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        &nbsp;
                                        <a href="travel.php" class="btn btn-danger">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
