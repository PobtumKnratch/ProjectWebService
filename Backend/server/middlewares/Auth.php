...
class Auth extends JwtHandler{
    ...
    protected function fetchUser($user_id){
        try{
            $fetch_user_id = "SELECT `username`,`topic_id`,`firstname`,`lastname`,`email`,`user_status` FROM `datausers` WHERE `user_id`=:`user_id`";
            $query_stmt = $this->db->prepare($fetch_user_id);
